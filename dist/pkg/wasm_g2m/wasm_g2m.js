 ...
 * @returns {any}
 */
export function convert_splat_to_mesh(data, mode) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.convert_splat_to_mesh(ptr0, len0, mode);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function init_g2m() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.init_g2m();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_921a46cc350fdd62 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = '/pkg/wasm_g2m/wasm_g2m_bg.wasm';
    }
    const imports = __wbg_get_imports();
