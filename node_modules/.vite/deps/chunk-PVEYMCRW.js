    ...
    if (material) {
      ...
      options.extraInitializationsAsync = async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./color.vertex-RVDAOCNI.js"), import("./color.fragment-4USA6PPZ.js")]);
        } else {
          await Promise.all([import("./color.vertex-VANTLEAB.js"), import("./color.fragment-N3YIEOHF.js")]);
        }
      };
...
function GetCustomCode(shaderType, cameraFacing) {
  if (shaderType === "vertex") {
    ...
    cameraFacing && (obj["!gl_Position\\=viewProjection\\*worldPos;"] = "//");
    return obj;
  }
...
function GetCustomCode2(shaderType, cameraFacing) {
  if (shaderType === "vertex") {
    ...
    cameraFacing && (obj["!vertexOutputs\\.position\\s=\\sscene\\.viewProjection\\s\\*\\sworldPos;"] = "//");
    return obj;
  }
  if (shaderType === "fragment") {
    return {
    ...
    super(name, scene, {
      ...
      extraInitializationsAsync: async () => {
        if (isWGSL) {
          ...
          await Promise.all([import("./greasedLine.vertex-FEO4KWY7.js"), import("./greasedLine.fragment-BYTPZNON.js")]);
        }
      },
...
//# sourceMappingURL=chunk-PVEYMCRW.js.map
