...
function blockFactory(blockName) {
  switch (blockName) {
    case "FlowGraphPlayAnimationBlock":
      return async () => (await import("./flowGraphPlayAnimationBlock-SUSOHFXX.js")).FlowGraphPlayAnimationBlock;
    ...
    case "FlowGraphReceiveCustomEventBlock":
      return async () => (await import("./flowGraphReceiveCustomEventBlock-WQFVPKG7.js")).FlowGraphReceiveCustomEventBlock;
      ...
      const effect = scene.getEngine().createEffect("gaussianSplatting", {
        ...
        extraInitializationsAsync: async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./gaussianSplatting.fragment-QV7SSBZG.js"), import("./gaussianSplatting.vertex-HN7MZYXZ.js")]);
          } else {
            await Promise.all([import("./gaussianSplatting.fragment-CWYNK7VQ.js"), import("./gaussianSplatting.vertex-VH3J7IWL.js")]);
          }
        }
      }, engine);
...
//# sourceMappingURL=chunk-OO2HUPXY.js.map
